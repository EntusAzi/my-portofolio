...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#000000]">
      ...
      <div className="relative h-screen flex items-center justify-center px-4 md:px-8">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            {/* Left Side - Text */}
            <div className="col-span-1 lg:col-span-6 text-center lg:text-left space-y-6 lg:space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-3 lg:gap-4">
                  <h1 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-semibold whitespace-nowrap">
                    I'm Ready For Job
                  </h1>
                  <RotatingText 
                    texts={['Web Developer', 'UI/UX Designer', 'Freelancer']}
                    mainClassName="px-4 lg:px-6 bg-gradient-to-r from-[#00d1b2] to-[#80D8C3] text-black overflow-hidden py-2 lg:py-3 justify-center rounded-xl text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold inline-flex transition-all shadow-lg hover:shadow-xl hover:scale-105 duration-300"
                    staggerFrom={"last"}
                    initial={{ y: "100%" }}
                    animate={{ y: 0 }}
                    exit={{ y: "-120%" }}
                ...
                <div className="mt-6 lg:mt-8">
                  <TrueFocus 
                    sentence="Passionate developer creating digital experiences that matter"
                    manualMode={true}
                    blurAmount={5}
                    borderColor="#00d1b2"
                    glowColor="rgba(0, 209, 178, 0.4)"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-8">
                <button className="px-8 py-4 bg-gradient-to-r from-[#00d1b2] to-[#80D8C3] text-black font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-lg">
                  View My Work
                </button>
                <button className="px-8 py-4 bg-transparent border-2 border-[#00d1b2] text-[#00d1b2] font-bold rounded-xl hover:bg-[#00d1b2]/10 hover:scale-105 transition-all duration-300 text-lg">
                  Get In Touch
                </button>
              </div>
            </div>
            ...
            {/* Right Side - Lanyard */}
            <div className="col-span-1 lg:col-span-6 flex items-center justify-center mt-8 lg:mt-0">
              ...
              <SpotlightCard>
                <div className="p-6 md:p-8">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#00d1b2] to-[#80D8C3] rounded-xl flex items-center justify-center shadow-lg">
                      <span className="text-black font-bold text-xl">💻</span>
                    </div>
                    <div>
                      <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">DEVELOP</h3>
                      <div className="w-20 h-1 bg-gradient-to-r from-[#00d1b2] to-transparent rounded-full"></div>
                    </div>
                  </div>
                  
                  <p className="text-gray-300 text-lg leading-relaxed mb-8">
                    <DecryptedText text="Started creating Web Development using NextJS, React, and Tailwind and eventually switched to Mobile Development using React Native. Passionate about creating scalable and user-friendly applications." />
                  </p>

                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-[#00d1b2] mb-4">Technologies & Tools</h4>
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        <span
                          key={skill.name}
                          className={`px-4 py-2 rounded-full bg-gradient-to-r ${skill.color} text-white text-sm font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer`}
                        >
                          {skill.name}
                        </span>
                      ))}
              ...
              <SpotlightCard>
                <div className="p-6 md:p-8">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">CREATE</h3>
                      <div className="w-20 h-1 bg-gradient-to-r from-purple-500 to-transparent rounded-full"></div>
                    </div>
                  </div>
                  
                  <p className="text-gray-300 text-lg leading-relaxed mb-8">
                    <DecryptedText text="Aspiring content creator and junior developer, passionate about telling stories through both words and code. Currently learning and building beautiful digital experiences that engage and inspire." />
                  </p>

                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-purple-400 mb-4">Design & Creation Tools</h4>
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        <span
                          key={tool.name}
                          className={`px-4 py-2 rounded-full bg-gradient-to-r ${tool.color} text-white text-sm font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer`}
                        >
                          {tool.name}
                        </span>
                      ))}
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-transparent via-gray-900/20 to-transparent">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-20">
            ...
            <div className="w-32 h-1 bg-gradient-to-r from-[#00d1b2] to-[#80D8C3] mx-auto rounded-full mb-6"></div>
            ...
            <div className="space-y-12 relative">
              ...
              <div className="flex items-center relative">
                <div className="w-full lg:w-5/12 lg:pr-8">
                  <div className="group bg-gradient-to-r from-gray-900/90 to-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 hover:border-[#00d1b2]/50 transition-all duration-500 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-lg font-bold text-white group-hover:text-[#00d1b2] transition-colors duration-300">
                        Teknologi Rekayasa Perangkat Lunak
                      </h3>
                      <p className="text-sm font-medium text-[#00d1b2]">Institut Pertanian Bogor</p>
                      ...
                      <div className="flex flex-wrap gap-1 mt-3">
                        <span className="px-2 py-1 bg-[#00d1b2]/20 text-[#00d1b2] rounded-full text-xs border border-[#00d1b2]/30">
                          Programming
                        </span>
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-[#00d1b2] to-[#80D8C3] rounded-full border-3 border-gray-900 shadow-lg z-10 flex items-center justify-center">
              ...
              <div className="flex items-center relative">
                ...
                {/* Timeline Dot */}
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full border-3 border-gray-900 shadow-lg z-10 flex items-center justify-center">
                    <div className="w-2 h-2 bg-gray-900 rounded-full"></div>
                  </div>
              ...
              <div className="flex items-center relative">
                ...
                {/* Timeline Dot */}
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full border-3 border-gray-900 shadow-lg z-10 flex items-center justify-center">
                    <div className="w-2 h-2 bg-gray-900 rounded-full"></div>
                  </div>
              ...
              <div className="flex items-center relative">
                ...
                {/* Timeline Dot */}
                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-orange-500 to-red-500 rounded-full border-3 border-gray-900 shadow-lg z-10 flex items-center justify-center">
                    <div className="w-2 h-2 bg-gray-900 rounded-full"></div>
                  </div>
          ...
          <div className="text-center mt-20">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-[#00d1b2]/20 to-purple-500/20 rounded-full border border-[#00d1b2]/30">
              <div className="w-3 h-3 bg-[#00d1b2] rounded-full animate-pulse"></div>
              <span className="text-[#00d1b2] font-medium">Currently open for new opportunities</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* My Projects Section */}
      <section className="py-16 md:py-24 px-4 md:px-8 bg-gradient-to-b from-gray-900/30 to-transparent">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white mb-6 bg-gradient-to-r from-white to-[#00d1b2] bg-clip-text text-transparent">
              My Projects
            </h2>
            <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              ...
              <div className="p-6 md:p-10">
                <div className="flex flex-col lg:flex-row items-center gap-8 mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#00d1b2] to-[#80D8C3] rounded-2xl flex items-center justify-center shadow-lg">
                      <span className="text-black font-bold text-2xl">📊</span>
                    </div>
                    <div>
                      <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">GitHub Activity</h3>
                      <div className="w-24 h-1 bg-gradient-to-r from-[#00d1b2] to-transparent rounded-full"></div>
                    </div>
                  </div>
                  <div className="text-center lg:text-left">
                    <p className="text-gray-400 text-lg">Consistent development activity and continuous learning</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                  <div className="flex flex-col md:flex-row items-center gap-6">
                    <span className="text-gray-300 font-medium">
                      <span className="text-[#00d1b2] text-xl font-bold">199</span> contributions in the last year
                    </span>
            ...
            <SpotlightCard>
              <div className="p-8 md:p-16">
                <div className="max-w-3xl mx-auto">
                  <div className="mb-8">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#00d1b2] to-[#80D8C3] rounded-3xl mx-auto mb-6 flex items-center justify-center shadow-2xl">
                      <span className="text-black text-3xl">🚀</span>
                    </div>
                    <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-4 bg-gradient-to-r from-white to-[#00d1b2] bg-clip-text text-transparent">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
                    <button className="group px-8 md:px-10 py-4 md:py-5 bg-gradient-to-r from-[#00d1b2] to-[#80D8C3] text-black font-bold rounded-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-lg relative overflow-hidden">
                      <span className="relative z-10 flex items-center justify-center gap-2">
                        <span>View More Projects</span>
                        <span className="group-hover:translate-x-1 transition-transform duration-300">→</span>
                      </span>
                    </button>
                    <button className="group px-8 md:px-10 py-4 md:py-5 bg-transparent border-2 border-[#00d1b2] text-[#00d1b2] font-bold rounded-2xl hover:bg-[#00d1b2]/10 hover:scale-105 transition-all duration-300 text-lg relative overflow-hidden">
                      <span className="relative z-10 flex items-center justify-center gap-2">
                  ...
                  <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-bold text-[#00d1b2] mb-2">15+</div>
                      <div className="text-gray-400">Projects Completed</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-bold text-[#00d1b2] mb-2">3+</div>
                      <div className="text-gray-400">Years Experience</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-bold text-[#00d1b2] mb-2">100%</div>
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50">
        <div className="backdrop-blur-xl bg-gray-900/80 rounded-2xl border border-gray-700/50 shadow-2xl p-2">
          <Dock 
            items={items}
            panelHeight={68}
            baseItemSize={50}
